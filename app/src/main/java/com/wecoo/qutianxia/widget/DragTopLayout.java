...
public class DragTopLayout extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        // init from attrs
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.dragTopStyle);
        setCollapseOffset(a.getDimensionPixelSize(R.styleable.dragTopStyle_dtlCollapseOffset, collapseOffset));
        overDrag = a.getBoolean(R.styleable.dragTopStyle_dtlOverDrag, overDrag);
        dragContentViewId = a.getResourceId(R.styleable.dragTopStyle_dtlDragContentView, -1);
        topViewId = a.getResourceId(R.styleable.dragTopStyle_dtlTopView, -1);
        initOpen(a.getBoolean(R.styleable.dragTopStyle_dtlOpen, true));
        captureTop = a.getBoolean(R.styleable.dragTopStyle_dtlCaptureTop, true);
        a.recycle();
    }
    ...
    // top 不能点击
    public void setCaptureTop(boolean captureTop) {
