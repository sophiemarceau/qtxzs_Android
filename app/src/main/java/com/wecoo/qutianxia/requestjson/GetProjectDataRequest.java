...
public class GetProjectDataRequest extends BaseRequest {
    ...
    // 设置请求的参数
    public void setRequestParms(String project_sort, String project_industry, int currentPage, int pageSize) {
