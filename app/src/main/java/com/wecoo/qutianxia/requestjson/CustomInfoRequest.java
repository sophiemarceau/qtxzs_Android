...
public class CustomInfoRequest extends BaseRequest {

    public CustomInfoRequest() {
        super(WebUrl.getCustomerDto4User);
    }
            ...
            public void onRequestSucceed(int what, String SucceedData) {
                if (SucceedData != null) {
                    try {
                        ...
                        CustomInfoEntity entity = JSONObject.parseObject(jsonObject.getString(getdto), CustomInfoEntity.class);
